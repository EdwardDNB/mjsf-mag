# Лабораторна робота №1. Створення компонентів з використанням Vue 3 та Tailwind CSS
...
6. Розмістіть ваш проект в директорії `lab1` публічного репозиторію GitHub/GitLab/Bitbucket з назвою `<vendor>/mjsf-mag`
